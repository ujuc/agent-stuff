...
> Source: dotrc/docs/ai/gitmessage.md (verbatim copy)
> Copied here for skill self-containment — the commit skill must not depend on files outside the agents/ submodule tree.
